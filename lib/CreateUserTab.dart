  ...
  Widget build(BuildContext context) {
    if (c
                          ...
                          children: <Widget>[
                            ...
                            new TextField(
                              decoration: new InputDecoration(
                                labelText: "Password",
                                hintText:
                                'Probably a good idea to keep it a secret ;)',
                              ),
                              keyboardType: TextInputType.text,
                              obscureText: true,
                            ...
                            new MaterialButton(
                              ...
                              onPressed: () async {
                                ...
                                User user = new User(null, _username.text,
                                    _initials.text, _password.text, roles);
      ...
      return Container(
        ...
        child: Text(
          "Du har ikke administrative \nrettigheder til at oprette brugere.",
